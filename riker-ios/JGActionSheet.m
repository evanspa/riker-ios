...
- (void)setButtonStyle:(JGActionSheetButtonStyle)buttonStyle forButton:(UIButton *)button {
  ...
  CGFloat systemFontSize = [PEUIUtils valueIfiPhone5Width:15.0
                                             iphone6Width:15.0
                                         iphone6PlusWidth:16.0
                                                     ipad:18.0];
  UIFont *font = [UIFont systemFontOfSize:systemFontSize];
...
- (CGRect)layoutForWidth:(CGFloat)width {
  CGFloat buttonHeight = [PEUIUtils valueIfiPhone5Width:40.0 iphone6Width:40.0 iphone6PlusWidth:42.0 ipad:47.0];
...
- (void)layoutSheetInitial:(BOOL)initial {
  ...
  if (iPad) {
    CGFloat fixedWidth = kFixedWidth + [PEUIUtils valueIfiPhone5Width:0.0 iphone6Width:0.0 iphone6PlusWidth:0.0 ipad:IPAD_ALERT_PANEL_EXTRA_WIDTH];
